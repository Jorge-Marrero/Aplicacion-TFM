...
class UsuariosDisponiblesAdapter(private val ctx: Context, private val contactos: List<Contacto>?) : BaseAdapter(){
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        nombre.text = ("Nombre: ${contacto.nombre}")
        tlf.text = ("Telefono: ${contacto.prefix}${contacto.tlf}")
